            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url('goods/create'); ?>" method="POST" role="form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="jenis" id="jenis" class="form-control" value="<?= set_value('jenis'); ?>">
                                        <?= form_error('jenis'); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="cpu" id="cpu" class="form-control" value="<?= set_value('cpu'); ?>">
                                        <?= form_error('cpu'); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <a href="<?= site_url('goods/index'); ?>" class="btn btn-default btn-block">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
